...
function iphorm_add_insert_button()
{
    if (current_user_can('iphorm_list_forms')) {
        ...
        echo '<a href="' . $href . '" class="thickbox iphorm-insert-form-trigger" title="' . esc_attr__('Add Quform', 'iphorm') . '"><span></span>' . esc_html__('Add Quform', 'iphorm') . '</a>';
    }
}
