<?php if (!defined('IPHORM_VERSION')) exit; ?><div class="wrap">
    ...
    <h2 class="ifb-main-title"><span class="ifb-iphorm-title"><?php echo esc_html(iphorm_get_plugin_name()); ?></span><span class="ifb-iphorm-title-forms"><?php esc_html_e('Forms', 'iphorm'); ?></span> <a href="admin.php?page=iphorm_form_builder" class="ifb-add-new-form-button"><?php esc_html_e('Add New', 'iphorm'); ?><span class="ifb-add-icon"></span></a></h2>
