...
<div class="wpcss-settings">
	...
	<div class="left">
		<div class="fieldset">
			...
			<textarea name="sc_template" rows="10" cols="40"><?php echo esc_textarea(get_post_meta($post->ID,'sc_template',true))?></textarea>
		</div>	
	</div>
	<div class="clearer"></div>
			...
			<tr>
				...
				<td class="col2">
					<select id="css_field_type" name="css_field_type" class="css-field-type" >
						...
						<option value='wp_uploader'>WP Media Uploader</option>
					</select>				
				</td>
				<td class="col3">&nbsp;</td>
			</tr>
