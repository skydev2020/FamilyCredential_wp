...
Tags: WordPress, Shortcodes, Shortcode API, jQuery UI, jQuery TOOLS, Toggle, Tabs, Accordion, Syntax Highlighter, Custom underlined links, Overlay, Buttons, Columns, Google Maps, Blockquotes, Pullquotes, Tables, Dividers, Colored Boxes, Picture frames, Tooltips, Facebook, Twitter, LinkedIN, Flattr, Twitter follow me, Google +1, Responsive Columns
Requires at least: 3.1
Tested up to: 3.9.1
Stable tag: 1.9.0 rev50424

======== Changelog =======
Version 1.9.0 rev50424 - June 2, 2014
* Update: LightBox js updated

Version 1.8.9 rev49192 - April 24, 2014
* Compatibility Fix: Sites updating to 1.8.8 still get the Javascript error on pages using TinyMCE. Renamed file to force non-cached version.

Version 1.8.8 rev48941 - April 17, 2014
* Compatibility Fix: Visual Columns was breaking the TinyMCE editor in WordPress 3.9
* New Feature: Field wp_uploader. Allows to upload images from wp media instead of copy and pasting image URLs into the field. Requires Shortcode to be modified so that the wp_uploader field is loaded.

Version 1.8.7 rev39396 - August 30, 2013
* Bug Fixed: Loading bundled jQuery UI in WordPress 3.6

Verison 1.8.6 rev38724 - August 7, 2013
* Bug Fixed: Prevent a warning about set_time limit

Version 1.8.5 rev38688 - August 6, 2013
* Bug Fixed: Temp fix for Lightbox Evolution until the author fixes a bug related to identifying jQuery UI version properly. 
* Bug Fixed: Downloadable Content not working. Added missing parameters for latest version of the DLC API.
...
Version 1.8.1 rev28805 - August 14, 2012
* New Feature: Added Visual Columns (Fluid grid system, 12 responsive percent-based columns)
* Update: Modified the Shortcode Insert Tool, so that it can work on pages with multiple instances of the editor
* Bug Fixed: Reorganize jQuery plugin to prevent Javascript error on some setups
* Bug Fixed: Quick edit options were getting squeezed to the left by Visual Columns CSS
...
14) Bootstrap, from Twitter (http://twitter.github.com/bootstrap/scaffolding.html)