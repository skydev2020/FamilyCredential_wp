<?php
	...
	*/ 
	...
	function register_meta_script(){
		...
		}else if( $post_type == 'post' || $post_type == 'portfolio' ){
	...
	function register_goodlayers_panel_scripts(){
		...
		wp_register_script('jquery-ui', 'http://ajax.googleapis.com/ajax/libs/jqueryui/1.8.16/jquery-ui.js', false, '1.0', false);
