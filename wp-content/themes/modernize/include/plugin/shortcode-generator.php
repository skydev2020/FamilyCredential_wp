<?php
	...
	function gdl_tab_shortcode( $atts, $content = null ){
		...
		for($i=0; $i<$num; $i++){
			...
			$tab = $tab . '<li><a href="#' . $tab_id  . '" class="gdl-title ';
	...
	function gdl_vimeo_shortcode( $atts, $content = null ){
		...
		return '<iframe src="http://player.vimeo.com/video/' . $id[1] . '?title=0&byline=0&portrait=0" width="' . $width . '" height="' . $height . '" frameborder="0" webkitAllowFullScreen allowfullscreen></iframe>';
