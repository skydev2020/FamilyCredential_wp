...
jQuery(document).ready(function(){ 
	...
	var DIV_SIZE = [
		['1/4','element1-4',1/4,['Column','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item']],
		['1/3','element1-3',1/3,['Column','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item']],
		['1/2','element1-2',1/2,['Column','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item']],
		['2/3','element2-3',2/3,['Column','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item']],
		['3/4','element3-4',3/4,['Column','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Price-Item']],
		['1/1','element1-1',1,['Column','Blog','Page','Portfolio','Testimonial','Slider','Accordion','Tab','Divider','Message-Box','Toggle-Box','Column-Service','Stunning-Text','Contact-Form','Price-Item']]
	];
