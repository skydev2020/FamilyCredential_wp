				<?php
					$text = '<span class="noselection gravity_forms_styler_media_select button">'.__('Select Image','gravity-forms-styler').'</span>';
					$bg = '';
					if(!empty($value)){
						...
						if(floatval($attachment[0]) > 0){
							...
							$text = '<span class="remove">&times;</span>'.$setsize.$sizebuttons.'<span class="filechanger-btn gravity_forms_styler_media_select changer">'.__('Change Image','gravity-forms-styler').'</span>';
							...
							$text = '<span class="remove">&times;</span><span class="filechanger-btn gravity_forms_styler_media_select changer">'.__('Change Image','gravity-forms-styler').'</span><span class="preview">'.$sizes[0].'x'.$sizes[1].'</span>';
					...
					echo '	<div class="image-field-gravity-forms-styler imgpreview" '.$bg.'>'.$text.'</div>';
					echo '</div>';
					?>